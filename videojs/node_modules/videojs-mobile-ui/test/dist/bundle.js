  ...
  * Debounces to either handle a delayed single tap, or a double tap
  ...
  TouchOverlay.prototype.handleTap = function handleTap(event) {
    ...
    if (this.firstTapCaptured) {
      ...
      if (this.timeout) {
        window_1.clearTimeout(this.timeout);
      }
      this.handleDoubleTap(event);
    } else {
      this.firstTapCaptured = true;
      this.timeout = window_1.setTimeout(function () {
  ...
  TouchOverlay.prototype.handleDoubleTap = function handleDoubleTap(event) {
    ...
    this.removeClass('skip');
    window_1.requestAnimationFrame(function () {
...
var angle = function angle() {
  // iOS
  if (typeof window_1.orientation === 'number') {
    return window_1.orientation;
  }
  // Android
...
var onPlayerReady = function onPlayerReady(player, options) {
  ...
  if (videojs.browser.IS_IOS) {
    window_1.addEventListener('orientationchange', rotationHandler);
  } else {
...
QUnit.test('the environment is sane', function (assert) {
  ...
  assert.strictEqual(typeof mobileUi === 'undefined' ? 'undefined' : _typeof(mobileUi), 'function', 'plugin is a function');
});
...
QUnit.test('registers itself with video.js', function (assert) {
  ...
  assert.strictEqual(_typeof(Player.prototype.mobileUi), 'function', 'videojs-mobile-ui plugin was registered');
});
